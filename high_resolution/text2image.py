...
from infoscale_sd_utils import *
...
def pipeline_processor(
    ...
    def forward(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            decrease_amount = start_value / (decrease_steps - 1)
                ...
                if do_classifier_free_guidance:
                    ...
                    if i == 0:
                        ...
                        for index in range(batch_size):
                            ...
                            noise_pred_text[index] = freq_mix_3d(noise_pred_text[index], con_adain, d_s=d_s, mix_alpha=xishu)                        
                            noise_pred_uncond[index] = freq_mix_3d(noise_pred_uncond[index], uncond_adain, d_s=d_s, mix_alpha=xishu)
